...
public:
    ...
    void retranslateUi(QDialog *SettingW)
    {
        ...
        txt_username->setPlaceholderText(QString());
        ...
        txt_biography->setPlaceholderText(QString());
